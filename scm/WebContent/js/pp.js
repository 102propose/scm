...
//		alert($.toJSON(param));
	$.ajax({
		type: 'post',
		url : PNT.Constants.context + "/pp/select/getList.do",
		data : param,
...
$(window).load(function() {
	...
	dxGrid.setHeader("작업지시번호,생산제품,제품명,계획수량,생산일자,실적수량", null, ["text-align:center","text-align:center","text-align:center","text-align:center","text-align:center","text-align:center"]);
	dxGrid.setInitWidths("120,140,200,100,100,100");
	dxGrid.setColAlign("left,left,left,right,left, right");
