...
@Controller
@RequestMapping(value = "/puHistoryPdf")
public class PuHistoryPdfController {
    ...
    public View page(HttpServletRequest request, HttpServletResponse response, Model model, HttpSession session) throws Exception {
    	...
    	// PdfWriter 생성
    	String pdfdir = "/tempPdf/pu/puHistoryPdf.pdf";
    	...
    	XMLWorkerHelper helper = XMLWorkerHelper.getInstance();    	     
     	...
     	fontProvider.register(contextPath+"/font/ciacode39_h.ttf", "Cia"); //바코드	
    	...
    	//납품내역리스트 데이터 loading..
    	List<PuInfoVO> data = this.puService.selectPuHistoryPdfList(vo);
        
        //파트너사 정보 가져오기.
        PuInfoVO puInfoVo = puService.selectPuHistoryHeadInfo(vo);
     	String no_company = "";
    	...
    	+"		  	  		<p style='font-family: MalgunGothic; font-size:12px;'>"+ data.get(0).getNo_po() +"</p>"
    	+"		  		</td>	                                                                                                                                      "
    	...
    	+"	    			<p style='font-family: MalgunGothic; font-size:14px;'>"+ dt_rcv.substring(0, 4)+"-"+dt_rcv.substring(4, 6)+"-"+dt_rcv.substring(6, 8) +"</p>"
    	+"		  		</td>"    	
    	+"		  		<td colspan='2' style='width: 76px; height: 27px; text-align: center;'>"
    	...
    	+"		  		</td>"  
    	+"		  		<td colspan='3' style='width: 114px; height: 27px; text-align: center;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:14px;'>"+ data.get(i).getCd_item() + "</p>"
    	+"		  		</td>"    	
    	+"		  		<td colspan='4' style='width: 152px; height: 27px; text-align: left;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:10px;'>&nbsp;"+ data.get(i).getNm_item() + "</p>"
    	+"		  		</td>"
    	+"		  		<td colspan='4' style='width: 152px; height: 27px; text-align: left;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:10px;'>&nbsp;"+ data.get(i).getStnd_item() + "</p>"
    	+"		  		</td>"
    	+"		  		<td style='width: 38px; height: 27px; text-align: center;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:14px;'>"+ data.get(i).getCd_unit_mm() + "</p>"
    	+"		  		</td>"
    	+"		  		<td colspan='2' style='width: 76px; height: 27px; text-align: right;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:14px;'>"+ df.format(Integer.parseInt(data.get(i).getQt_rcv())) + "&nbsp;</p>"    	
		+"		  		</td>" 
    	+"		  		<td colspan='4' style='width: 152px; height: 27px; text-align: left;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:10px;'>&nbsp;"+ data.get(i).getDesc_rcv() + "</p>"
    	+"		  		</td>"    	
    	+"		  		<td style='width: 38px; height: 27px; text-align: center;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:14px;'></p>"
    	+"		  		</td>"
    	...
    	for(int i=1; i < 8-data.size(); i++){
		htmlStr += "<tr>"
    	+"		  		<td style='width: 38px; height: 27px; text-align: center;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:14px;'>"+ (data.size()+i) + "</p>"
    	+"		  		</td>"  
    	+"		  		<td colspan='3' style='width: 114px; height: 27px; text-align: left;'>"
    	+"	    			<p style='font-family: MalgunGothic; font-size:14px;'></p>"
    	+"		  		</td>"    	
		...
		for(int i=0; i < data.size(); i++){ //for(bacode = 1; bacode < 8; bacode++){
		String po_no2 = data.get(i).getNo_po();
		System.out.println(po_no2);
		 htmlStr +="		<tr>                                                                                                                              "
		        	+"		  		<td style='width: 365px; height: 155px; text-align: center;'>                                                                                                                                        "
		        	+"	    			<p style='font-family: MalgunGothic;'>발주번호/품번/수량</p> "
		        	+"	    			<p style='font-family: MalgunGothic;'>*"+data.get(i).getNo_po()+"/"+ data.get(i).getCd_item() + "/"+data.get(i).getQt_rcv()+"*</p> "
		        	+"	    			<p style='font-family: MalgunGothic;'></p> "
		        	+"	    			<p style='font-family: MalgunGothic;'></p> "
		        	+"	    			<p style='font-family: MalgunGothic;'>&nbsp;</p> "
		        	+"	    			<p style='font-family: Cia;'>*"+ data.get(i).getNo_po()+data.get(i).getCd_item()+ data.get(i).getQt_rcv() +"*</p> "
		        	+"		  		</td>"    	
		        	...
		        	+"	    			<p style='font-family: MalgunGothic;'></p> "
		        	+"	    			<p style='font-family: MalgunGothic;'>&nbsp;</p> "
		        	+"	    			<p style='font-family: Cia;'>*"+ po_no2.substring(5)+data.get(i).getCd_item() + data.get(i).getQt_rcv() +"*</p> "
		        	+"		  		</td>"
		        	+"		</tr>";		        	
		}
		for(int i=1; i < 8-data.size(); i++){
