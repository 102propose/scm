...
public class OrderDAO extends SqlSessionDaoSupport {
    ...
    public List<OrderVO> selectCommonOrderList(OrderVO vo) throws Exception {
    	List<OrderVO> result = super.getSqlSession().selectList("Order.selectCommonOrderList", vo);
        return result;
    }
